...
if(EXISTS "${CMAKE_SOURCE_DIR}/vendor/lua/src/lua.h")
    file(STRINGS "${CMAKE_SOURCE_DIR}/vendor/lua/src/lua.h" LUA_VERSION_MAJOR_LINE REGEX "^#define LUA_VERSION_MAJOR[ \t]+\"[^\"]+\"")
    file(STRINGS "${CMAKE_SOURCE_DIR}/vendor/lua/src/lua.h" LUA_VERSION_MINOR_LINE REGEX "^#define LUA_VERSION_MINOR[ \t]+\"[^\"]+\"")
    file(STRINGS "${CMAKE_SOURCE_DIR}/vendor/lua/src/lua.h" LUA_VERSION_RELEASE_LINE REGEX "^#define LUA_VERSION_RELEASE[ \t]+\"[^\"]+\"")
